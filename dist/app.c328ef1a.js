...
var Pet = function Pet(props) {
  ...
  // ]);
  return _react.default.createElement("div", null, _react.default.createElement("h1", null, prop.name), _react.default.createElement("h2", null, prop.animal), _react.default.createElement("h2", null, prop.breed));
};
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(App).call(this, props)); //calling parent component, calls constuctor props and passing super props to props
